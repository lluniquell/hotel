    ...
    <c:if test="${tr3%3==0}">
      ...
      <tr>
        ...
        <span class="li" style="cursor:default;">  ≪  </span>
         ...
         <c:if test="${pstart!=1}">
           <a class="li" href="../cus_hugi/hugi_list?page=${pstart-1}"> ≪ </a>
         </c:if>
         <c:if test="${pstart==1}">
          <span class="li" style="cursor:default;">＜ </span>
         </c:if>
         <c:if test="${pstart!=1}">
           <a class="li" href="../cus_hugi/hugi_list?page=${page-1}">＜ </a>
         </c:if>
        
          <c:forEach begin="${pstart}" end="${pend}" var="i">
           <c:if test="${page==i}">
             <a class="plink" href="../cus_hugi/hugi_list?page=${i}" >${i}</a>
           </c:if>
           <c:if test="${page!=i}">
             <a class="plink" href="../cus_hugi/hugi_list?page=${i}">${i}</a>
           </c:if>
         ...
         <c:if test="${pend != chong}">
           <a class="li" href="../cus_hugi/hugi_list?page=${pend+1}"> ≫ </a>
         </c:if>
        </td>
      </tr>
    </table>
