...
<div id="faq_area">  
 ...
 <div id="answer_area"> 
     ...
     <c:forEach items="${alist}" var="afvo">
      ...
      <div class="ans"> 
       ...
       <div style="text-align:right;margin-top:10px;">
         <input type="button" value="수정" onclick="location='../ad_faq/faq_update?id=${afvo.id}'">
         <input type="button" value="삭제" onclick="location='../ad_faq/faq_delete?id=${afvo.id}'">
       </div>
      </div>    
    ...
    <c:set var="rr" value="0"/>
     <c:forEach items="${rlist}" var="rfvo">
      ...
      <div class="ans"> 
        ${rfvo.answer}
        <div style="text-align:right;margin-top:10px;">
         <input type="button" value="수정" onclick="location='../ad_faq/faq_update?id=${rfvo.id}'">
         <input type="button" value="삭제" onclick="location='../ad_faq/faq_delete?id=${rfvo.id}'">
       </div> 
      </div> 
    ...
    <c:set var="ss" value="0"/>
     <c:forEach items="${slist}" var="sfvo">
      ...
      <div class="ans"> 
        ${sfvo.answer} 
        <div style="text-align:right;margin-top:10px;">
         <input type="button" value="수정" onclick="location='../ad_faq/faq_update?id=${sfvo.id}'">
         <input type="button" value="삭제" onclick="location='../ad_faq/faq_delete?id=${sfvo.id}'">
       </div>
      </div>
    ...
    <c:set var="mm" value="0"/>
     <c:forEach items="${mlist}" var="mfvo">
      ...
      <div class="ans"> 
        ${mfvo.answer}
        <div style="text-align:right;margin-top:10px;"> 
         <input type="button" value="수정" onclick="location='../ad_faq/faq_update?id=${mfvo.id}'">
         <input type="button" value="삭제" onclick="location='../ad_faq/faq_delete?id=${mfvo.id}'">
       </div> 
      </div>
    ...
    <c:set var="ee" value="0"/>
     <c:forEach items="${elist}" var="efvo">
      ...
      <div class="ans"> 
        ${efvo.answer} 
        <div style="text-align:right;margin-top:10px;">
         <input type="button" value="수정" onclick="location='../ad_faq/faq_update?id=${efvo.id}'">
         <input type="button" value="삭제" onclick="location='../ad_faq/faq_delete?id=${efvo.id}'">
       </div>
      </div>
   ...
   <div style="margin-top:80px;text-align:center;">
     <input type="button" value="FAQ작성하기" onclick="location='../ad_faq/faq_write'">
   </div>
  </div> 
  </section>
</body>
