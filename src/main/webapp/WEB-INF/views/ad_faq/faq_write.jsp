...
<body>
  <section>    
    ...
    <form method="post" action="faq_write_ok" onsubmit="return check(this)">
     ...
     <h4> 질문 작성</h4>
      <div id="que_gubun"> 분류 :
        <input type="radio" name="gubun" value="0" checked> 예약
      ...
      <textarea cols="80" rows="3" name="question" placeholder="자주 묻는 질문을 입력해 주세요"></textarea> 
     </div>

     <div id="ans">
     <h4> 답변 작성</h4>
      <textarea cols="80" rows="10" name="answer" placeholder="자주 묻는 질문의 답변을 입력해 주세요"></textarea> 
     </div>
     
     <div id="btns">
       <input type="submit" value="FAQ등록"> <p>
